...
import com.jingjiang.baidumusic.widget.othertool.StreamRequest;
...
public class LyricView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LyricView_textsize, sp2px(14));
        mDividerHeight = ta.getDimension(R.styleable.LyricView_divider_Height, dp2px(22));
        mAnimationDuration = ta.getInt(R.styleable.LyricView_animation_duration, 1000);
        mAnimationDuration = mAnimationDuration < 0 ? 1000 : mAnimationDuration;
        int normalColor = ta.getColor(R.styleable.LyricView_textcolor_normal, 0xFFFFFFFF);
        int currentColor = ta.getColor(R.styleable.LyricView_textcolor_current, 0xFFFF4081);
        ta.recycle();
    ...
    public static int sp2px(float spValue) {
        final float fontScale = MyApplication.context.getResources().getDisplayMetrics().density;
...
//         无歌词文件
    ...
    public void loadNetLrc(String url) {
        ...
        VolleySingle.getInstance().getQueue().add(streamRequest);
