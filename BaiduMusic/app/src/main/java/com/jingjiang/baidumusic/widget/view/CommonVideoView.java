...
public class CommonVideoView extends FrameLayout implements MediaPlayer.OnPreparedListener,
    ...
    public void setFullScreen() {
        touchStatusImg.setImageResource(R.mipmap.bt_mv_suoxiao);
    ...
    public void setNormalScreen() {
        touchStatusImg.setImageResource(R.mipmap.bt_mv_fangda);
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(660, 330);
        videoView.requestLayout();
...
//        videoPauseBtn.setOnClickListener(this);
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        videoPauseImg.setImageResource(R.mipmap.bt_mv_pause_nor);
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        videoPauseImg.setImageResource(R.mipmap.bt_mv_play_nor);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (deltaXAbs > 1) {
                    ...
                    if (deltaX > 1) {
                        ...
                        touchStatusImg.setImageResource(R.mipmap.bt_mv_next_nor);
                        ...
                        touchPosition = position;
                        touchStatusImg.setImageResource(R.mipmap.bt_mv_prev_nor);
                        int[] time = getMinuteAndSecond(position);
                        touchStatusTime.setText(String.format("%02d:%02d/%s", time[0], time[1], formatTotalTime));
